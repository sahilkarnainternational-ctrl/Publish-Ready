...
export const CORE_COURSES: CourseTrack[] = [
  {
    ...
    units: bandTopics({
      ...
      'Grade 11': ['Units & dimensions', 'Kinematics', 'Newtonian mechanics', 'Thermodynamics', 'Waves', 'Optics', 'Electrostatics', 'Current electricity'],
      'Grade 12': ['Electromagnetism', 'Modern Physics', 'Special relativity', 'Quantum basics', 'Semiconductors', 'Communication systems', 'Nuclear physics', 'Rotational dynamics'],
  ...
  },
  {
    ...
    units: bandTopics({
      ...
      'Grade 11': ['Some basic concepts', 'Structure of atom', 'Classification of elements', 'Chemical bonding', 'Thermodynamics', 'Equilibrium', 'Redox reactions', 'Acids and bases', 'Periodic trends'],
      'Grade 12': ['Solid state', 'Solutions', 'Electrochemistry', 'Chemical kinetics', 'Surface chemistry', 'Organic Chemistry', 'Biomolecules', 'Polymers', 'Environmental chemistry'],
  ...
  },
  {
    ...
    units: bandTopics({
      ...
      'Grade 11': ['Living world', 'Biological classification', 'Plant morphology', 'Animal kingdom', 'Cell cycle', 'Biomolecules', 'Plant physiology', 'Genetics'],
      'Grade 12': ['Reproduction', 'Genetics', 'Evolution', 'Human health and disease', 'Biotechnology', 'Ecology', 'Microbes in human welfare', 'Environmental biology'],
  ...
  },
  {
    ...
    units: bandTopics({
      ...
      'Grade 10': ['Real numbers', 'Polynomials', 'Quadratic equations', 'Arithmetic progressions', 'Commercial math', 'Logarithms & exponents', 'Triangles', 'Trigonometry', 'Statistics & Probability', 'Coordinate geometry'],
      'Grade 11': ['Sets', 'Relations and functions', 'Trigonometry', 'Complex Numbers', 'Linear inequalities', 'Permutations and combinations', 'Binomial theorem', 'Sequences and series', 'Matrices', 'Determinants', 'Progressions', 'Number systems'],
      'Grade 12': ['Relations and functions', 'Inverse trigonometric functions', 'Matrices', 'Determinants', 'Continuity and differentiability', 'Integrals', 'Differential equations', 'Vectors', 'Probability', 'Statistics', 'Discrete mathematics'],
